...
def test_len_buckets_prefer_compile_sizes():
...
def test_len_buckets_stick_align_compile_sizes():
...
def test_warmup_shapes_use_max_model_len(monkeypatch):
    monkeypatch.setenv("SPYRE_ENCODER_BUCKET_BATCH_SIZES", "1,4")
